  ...
  <q-page padding class="row items-center justify-center">
    <div class="row full-width">
      <div class="col-md-8 offset-md-2 col-xs-12 q-pl-md q-pr-md q-pt-sm">
        <q-card flat="bg-white text-black">
          <div class="row">
            <div class="col-md-6 col-xs-12">
              <div class="row q-pt-md q-pb-md bg-teal-5">
                <div class="col-md-8 offset-2 col-xs-8">
                  <q-img spinner-color="white" placeholder-src="statics/person.png" src="statics/person.png">
                  </q-img>
                </div>
              </div>
            </div>
    ...
    <div class="q-pa-md">
      <q-card-section class="text-blue-gray-14">
        <div class="text=h-8">Login</div>
      </q-card-section>
    <q-form
      @submit="onSubmit"
      @reset="onReset"
